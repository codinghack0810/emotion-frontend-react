...
export default function Example() {
  ...
  const handle = (e) => {
    ...
    axios
      .get("https://emotionseo.ai:8000/user/getinfo/", { headers })
      .then((res) => {
  ...
  return (
    <Disclosure as="nav" className="z-10 bg-gray-800 fixed top-0 w-full">
      {({ open }) => (
        <>
...
<p className="text-[1.5rem] md:text-[2rem] from-fuchsia-700 to-purple-700 font-bold bg-gradient-to-r bg-clip-text text-transparent">
          EmotionSEO.ai
        </p>
